...
CREATE TYPE "public"."admin_role_enum" AS ENUM('super_admin', 'moderator', 'watcher', 'interviewer', 'problem_setter', 'restrict');--> statement-breakpoint
CREATE TYPE "public"."task_entity_enum" AS ENUM('interview', 'quiz', 'contest_stage', 'problem', 'job', 'none');--> statement-breakpoint
CREATE TYPE "public"."task_status_enum" AS ENUM('pending', 'in_progress', 'done', 'blocked');--> statement-breakpoint
CREATE TYPE "public"."task_type_enum" AS ENUM('interview_preparation', 'quiz_edit', 'contest_edit', 'problem_creation', 'bug_fix');--> statement-breakpoint
CREATE TYPE "public"."capability" AS ENUM('update.organizationDetails', 'create.job', 'update.job', 'delete.job', 'create.stage', 'update.stage', 'delete.stage', 'update.contest', 'create.contest_problem', 'update.contest_problem', 'delete.contest_problem', 'update.billing', 'view.analytics', 'create.invite', 'read.invite', 'update.invite', 'delete.invite', 'assign.task', 'view.task', 'update.task', 'delete.task', 'schedule.interview', 'take.interview', 'pass.candidate.stage', 'view.candidate.submissions', 'create.quiz_problem', 'update.quiz_problem', 'read.quiz_problem', 'update.quiz', 'generate.quiz', 'read.quiz');--> statement-breakpoint
CREATE TYPE "public"."color_scheme" AS ENUM('gray', 'blue', 'green', 'red', 'pink', 'orange', 'yellow', 'purple', 'teal', 'indigo');--> statement-breakpoint
CREATE TABLE "admins" (
	...
	"role" varchar DEFAULT 'restrict' NOT NULL,
	"role_id" varchar(256),
...
CREATE TABLE "contest_registrations" (
	...
	"job_registration_id" varchar(256),
...
CREATE TABLE "submissions" (
	...
	"contest_registeration_id" varchar(256) NOT NULL,
	"problem_id" varchar(256) NOT NULL,
	"contest_id" varchar(256),
	"code_key" varchar(512) NOT NULL,
...
CREATE TABLE "testcases" (
	...
	"type" "test_cases_type_enum" DEFAULT 'system' NOT NULL,
...
CREATE TABLE "tasks" (
	...
	"entity_type" "task_entity_enum" NOT NULL,
	"entity_id" uuid,
...
CREATE TABLE "roles" (
	...
	"organization_id" varchar NOT NULL,
	"colorScheme" "color_scheme" DEFAULT 'gray' NOT NULL,
...
--> statement-breakpoint
ALTER TABLE "admins" ADD CONSTRAINT "admins_role_id_roles_id_fk" FOREIGN KEY ("role_id") REFERENCES "public"."roles"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "organization_invite" ADD CONSTRAINT "organization_invite_role_id_roles_id_fk" FOREIGN KEY ("role_id") REFERENCES "public"."roles"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "tasks" ADD CONSTRAINT "tasks_assigned_to_admins_id_fk" FOREIGN KEY ("assigned_to") REFERENCES "public"."admins"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "tasks" ADD CONSTRAINT "tasks_created_by_admins_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."admins"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "quiz_id_problem_idx" ON "quiz_problems" USING btree ("quizId");--> statement-breakpoint
...
CREATE INDEX "created_by_idx" ON "tasks" USING btree ("created_by");--> statement-breakpoint
CREATE INDEX "organization_task_id_idx" ON "tasks" USING btree ("organization_id");--> statement-breakpoint
CREATE UNIQUE INDEX "org_id_tag_idx" ON "roles" USING btree ("organization_id","tag");